...
- [RAG Pipelines Mastery Path](https://sigilipelli.github.io/rag-skillmastery/) — retrieval-augmented generation
...
- [Python Testing Mastery Path](https://sigilipelli.github.io/python-testing-skillmastery/) — testing Python code and pipelines
